...
if not hasattr(Path, "contains_points"):
    try:
        from matplotlib.nxutils import points_inside_poly  # type: ignore
        ...
        class Path(MplPath):
            ...
            def contains_points(
                self, points: ArrayLike, transform=None, radius=0.0
            ) -> np.ndarray:
                """
                ...
                *radius* allows the path to be made slightly larger or
                ...
                result = np.sum(gen, axis=0)  # type: ignore
